...
theorem core_models_Array_Insts_index_mut_RangeUsize_spec
    ...
    core.Array.Insts.CoreOpsIndexIndexMut.index_mut
      (core.slice.index.SliceIndexRangeUsizeSlice T) arr r
  ...
  have h_slice_eq_core :
    ...
    have := hp_eq
    unfold core.slice.index.Slice.index_mut at this
    exact this
...
theorem keccak.absorb_final_spec
  ...
  have h_if_eq :
          ...
          (do
            ...
            let s3 ←
              core.slice.Slice.copy_from_slice
                core.U8.Insts.CoreMarkerCopy s s2
    ...
    · rw [if_pos hlen]
      ...
      have h_wrap_eq_im :
          ...
          = core.slice.index.SliceIndexRangeUsizeSlice Std.U8 := rfl
      rw [h_wrap_eq_im]
      ...
      show (do
              ...
              let s2 ← core.slice.index.Slice.index
                (core.slice.index.SliceIndexRangeUsizeSlice
                  Std.U8) last { start, «end» := i }
              let s3 ← core.slice.Slice.copy_from_slice
                core.U8.Insts.CoreMarkerCopy s_im s2
              ok (write_back s3)) = _
      ...
      obtain ⟨w, hw_eq, hw_val⟩ :=
        triple_exists_ok_af
          (core_models_slice_Slice_copy_from_slice_spec
            core.U8.Insts.CoreMarkerCopy s_im q h_p_q_len)
  ...
  have h_pad_eq :
    ...
    show (do
            ...
            let s2 ← core.slice.Slice.copy_from_slice
              core.U8.Insts.CoreMarkerCopy s s1
    ...
    show (do
            ...
            let s1 ← core.slice.index.Slice.index
              (core.slice.index.SliceIndexRangeUsizeSlice
                Std.U8) last { start := start, «end» := i }
            let s2 ← core.slice.Slice.copy_from_slice
              core.U8.Insts.CoreMarkerCopy s_im s1
  ...
  have h_block_idx_eq :
    ...
    -- This is the same as `core.slice.index.Slice.index`
    ...
    have h_slice_eq :
      ...
      have := hq_eq
      unfold core.slice.index.Slice.index at this
      exact this
    rw [h_slice_eq]
    apply congrArg
    apply Subtype.ext
