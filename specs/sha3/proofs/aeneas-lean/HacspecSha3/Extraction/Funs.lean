...
/-- [hacspec_sha3::keccak_f::theta_unrolled]:
    Source: 'src/keccak_f.rs', lines 141:0-183:1
    Visibility: public -/
def keccak_f.theta_unrolled
  ...
  let i4 ← lift (i2 ^^^ i3)
  let i5 ← Array.index_usize state 15#usize
  let i6 ← lift (i4 ^^^ i5)
  let i7 ← Array.index_usize state 20#usize
  let c0 ← lift (i6 ^^^ i7)
  let i8 ← Array.index_usize state 1#usize
  let i9 ← Array.index_usize state 6#usize
  let i10 ← lift (i8 ^^^ i9)
  let i11 ← Array.index_usize state 11#usize
  let i12 ← lift (i10 ^^^ i11)
  let i13 ← Array.index_usize state 16#usize
  let i14 ← lift (i12 ^^^ i13)
  let i15 ← Array.index_usize state 21#usize
  let c1 ← lift (i14 ^^^ i15)
  let i16 ← Array.index_usize state 2#usize
  let i17 ← Array.index_usize state 7#usize
  let i18 ← lift (i16 ^^^ i17)
  let i19 ← Array.index_usize state 12#usize
  let i20 ← lift (i18 ^^^ i19)
  let i21 ← Array.index_usize state 17#usize
  let i22 ← lift (i20 ^^^ i21)
  let i23 ← Array.index_usize state 22#usize
  let c2 ← lift (i22 ^^^ i23)
  let i24 ← Array.index_usize state 3#usize
  let i25 ← Array.index_usize state 8#usize
  let i26 ← lift (i24 ^^^ i25)
  let i27 ← Array.index_usize state 13#usize
  let i28 ← lift (i26 ^^^ i27)
  let i29 ← Array.index_usize state 18#usize
  let i30 ← lift (i28 ^^^ i29)
  let i31 ← Array.index_usize state 23#usize
  let c3 ← lift (i30 ^^^ i31)
  let i32 ← Array.index_usize state 4#usize
  let i33 ← Array.index_usize state 9#usize
  let i34 ← lift (i32 ^^^ i33)
  let i35 ← Array.index_usize state 14#usize
  let i36 ← lift (i34 ^^^ i35)
  let i37 ← Array.index_usize state 19#usize
...
/-- [hacspec_sha3::keccak_f::rho_unrolled]:
    Source: 'src/keccak_f.rs', lines 186:0-214:1
    Visibility: public -/
def keccak_f.rho_unrolled
  ...
  let i3 ← core_models.num.U64.rotate_left i2 1#u32
  let i4 ← Array.index_usize state 2#usize
  let i5 ← core_models.num.U64.rotate_left i4 62#u32
  let i6 ← Array.index_usize state 3#usize
  let i7 ← core_models.num.U64.rotate_left i6 28#u32
  let i8 ← Array.index_usize state 4#usize
  let i9 ← core_models.num.U64.rotate_left i8 27#u32
  let i10 ← Array.index_usize state 5#usize
  let i11 ← core_models.num.U64.rotate_left i10 36#u32
  ...
  let i15 ← core_models.num.U64.rotate_left i14 6#u32
  let i16 ← Array.index_usize state 8#usize
  let i17 ← core_models.num.U64.rotate_left i16 55#u32
  let i18 ← Array.index_usize state 9#usize
  let i19 ← core_models.num.U64.rotate_left i18 20#u32
  let i20 ← Array.index_usize state 10#usize
  let i21 ← core_models.num.U64.rotate_left i20 3#u32
  let i22 ← Array.index_usize state 11#usize
  let i23 ← core_models.num.U64.rotate_left i22 10#u32
  ...
  let i27 ← core_models.num.U64.rotate_left i26 25#u32
  let i28 ← Array.index_usize state 14#usize
  let i29 ← core_models.num.U64.rotate_left i28 39#u32
  let i30 ← Array.index_usize state 15#usize
  let i31 ← core_models.num.U64.rotate_left i30 41#u32
  let i32 ← Array.index_usize state 16#usize
  let i33 ← core_models.num.U64.rotate_left i32 45#u32
  let i34 ← Array.index_usize state 17#usize
  let i35 ← core_models.num.U64.rotate_left i34 15#u32
  ...
  let i39 ← core_models.num.U64.rotate_left i38 8#u32
  let i40 ← Array.index_usize state 20#usize
  let i41 ← core_models.num.U64.rotate_left i40 18#u32
  let i42 ← Array.index_usize state 21#usize
  let i43 ← core_models.num.U64.rotate_left i42 2#u32
  let i44 ← Array.index_usize state 22#usize
  let i45 ← core_models.num.U64.rotate_left i44 61#u32
  let i46 ← Array.index_usize state 23#usize
  let i47 ← core_models.num.U64.rotate_left i46 56#u32
...
/-- [hacspec_sha3::keccak_f::pi_unrolled]:
    Source: 'src/keccak_f.rs', lines 220:0-248:1
    Visibility: public -/
def keccak_f.pi_unrolled
  (state : Array Std.U64 25#usize) : Result (Array Std.U64 25#usize) := do
  let i ← Array.index_usize state 0#usize
  let i1 ← Array.index_usize state 6#usize
  let i2 ← Array.index_usize state 12#usize
  let i3 ← Array.index_usize state 18#usize
  let i4 ← Array.index_usize state 24#usize
  let i5 ← Array.index_usize state 3#usize
  let i6 ← Array.index_usize state 9#usize
  let i7 ← Array.index_usize state 10#usize
  let i8 ← Array.index_usize state 16#usize
  let i9 ← Array.index_usize state 22#usize
  let i10 ← Array.index_usize state 1#usize
  let i11 ← Array.index_usize state 7#usize
  let i12 ← Array.index_usize state 13#usize
  let i13 ← Array.index_usize state 19#usize
  let i14 ← Array.index_usize state 20#usize
  let i15 ← Array.index_usize state 4#usize
  let i16 ← Array.index_usize state 5#usize
  let i17 ← Array.index_usize state 11#usize
  let i18 ← Array.index_usize state 17#usize
  let i19 ← Array.index_usize state 23#usize
  let i20 ← Array.index_usize state 2#usize
  let i21 ← Array.index_usize state 8#usize
  let i22 ← Array.index_usize state 14#usize
  let i23 ← Array.index_usize state 15#usize
  let i24 ← Array.index_usize state 21#usize
  ok
    (Array.make 25#usize [
...
/-- [hacspec_sha3::keccak_f::chi_unrolled]:
    Source: 'src/keccak_f.rs', lines 254:0-282:1
    Visibility: public -/
def keccak_f.chi_unrolled
  ...
  let i9 ← lift (i1 ^^^ i8)
  let i10 ← lift (~~~ i7)
  let i11 ← Array.index_usize state 4#usize
  let i12 ← lift (i10 &&& i11)
  let i13 ← lift (i3 ^^^ i12)
  let i14 ← lift (~~~ i11)
  let i15 ← lift (i14 &&& i)
  ...
  let i17 ← lift (~~~ i)
  let i18 ← lift (i17 &&& i1)
  let i19 ← lift (i11 ^^^ i18)
  let i20 ← Array.index_usize state 5#usize
  let i21 ← Array.index_usize state 6#usize
  let i22 ← lift (~~~ i21)
  let i23 ← Array.index_usize state 7#usize
  let i24 ← lift (i22 &&& i23)
  let i25 ← lift (i20 ^^^ i24)
  let i26 ← lift (~~~ i23)
  let i27 ← Array.index_usize state 8#usize
  let i28 ← lift (i26 &&& i27)
  let i29 ← lift (i21 ^^^ i28)
  let i30 ← lift (~~~ i27)
  let i31 ← Array.index_usize state 9#usize
  let i32 ← lift (i30 &&& i31)
  let i33 ← lift (i23 ^^^ i32)
  let i34 ← lift (~~~ i31)
  let i35 ← lift (i34 &&& i20)
  let i36 ← lift (i27 ^^^ i35)
  let i37 ← lift (~~~ i20)
  let i38 ← lift (i37 &&& i21)
  let i39 ← lift (i31 ^^^ i38)
  let i40 ← Array.index_usize state 10#usize
  let i41 ← Array.index_usize state 11#usize
  let i42 ← lift (~~~ i41)
  let i43 ← Array.index_usize state 12#usize
  let i44 ← lift (i42 &&& i43)
  let i45 ← lift (i40 ^^^ i44)
  let i46 ← lift (~~~ i43)
  let i47 ← Array.index_usize state 13#usize
  let i48 ← lift (i46 &&& i47)
  let i49 ← lift (i41 ^^^ i48)
  let i50 ← lift (~~~ i47)
  let i51 ← Array.index_usize state 14#usize
  let i52 ← lift (i50 &&& i51)
  let i53 ← lift (i43 ^^^ i52)
  let i54 ← lift (~~~ i51)
  let i55 ← lift (i54 &&& i40)
  let i56 ← lift (i47 ^^^ i55)
  let i57 ← lift (~~~ i40)
  let i58 ← lift (i57 &&& i41)
  let i59 ← lift (i51 ^^^ i58)
  let i60 ← Array.index_usize state 15#usize
  let i61 ← Array.index_usize state 16#usize
  let i62 ← lift (~~~ i61)
  let i63 ← Array.index_usize state 17#usize
  let i64 ← lift (i62 &&& i63)
  let i65 ← lift (i60 ^^^ i64)
  let i66 ← lift (~~~ i63)
  let i67 ← Array.index_usize state 18#usize
  let i68 ← lift (i66 &&& i67)
  let i69 ← lift (i61 ^^^ i68)
  let i70 ← lift (~~~ i67)
  let i71 ← Array.index_usize state 19#usize
  let i72 ← lift (i70 &&& i71)
  let i73 ← lift (i63 ^^^ i72)
  let i74 ← lift (~~~ i71)
  let i75 ← lift (i74 &&& i60)
  let i76 ← lift (i67 ^^^ i75)
  let i77 ← lift (~~~ i60)
  let i78 ← lift (i77 &&& i61)
  let i79 ← lift (i71 ^^^ i78)
  let i80 ← Array.index_usize state 20#usize
  let i81 ← Array.index_usize state 21#usize
  let i82 ← lift (~~~ i81)
  let i83 ← Array.index_usize state 22#usize
  let i84 ← lift (i82 &&& i83)
  let i85 ← lift (i80 ^^^ i84)
  let i86 ← lift (~~~ i83)
  let i87 ← Array.index_usize state 23#usize
  let i88 ← lift (i86 &&& i87)
  let i89 ← lift (i81 ^^^ i88)
  let i90 ← lift (~~~ i87)
  let i91 ← Array.index_usize state 24#usize
  let i92 ← lift (i90 &&& i91)
  let i93 ← lift (i83 ^^^ i92)
  let i94 ← lift (~~~ i91)
  let i95 ← lift (i94 &&& i80)
  let i96 ← lift (i87 ^^^ i95)
  let i97 ← lift (~~~ i80)
  let i98 ← lift (i97 &&& i81)
  let i99 ← lift (i91 ^^^ i98)
  ok
    (Array.make 25#usize [
      i5, i9, i13, i16, i19, i25, i29, i33, i36, i39, i45, i49, i53, i56, i59,
      i65, i69, i73, i76, i79, i85, i89, i93, i96, i99
      ])

/-- [hacspec_sha3::keccak_f::keccak_f]: loop body 0:
    Source: 'src/keccak_f.rs', lines 292:4-294:5
    Visibility: public -/
@[rust_loop_body]
...
/-- [hacspec_sha3::keccak_f::keccak_f]:
    Source: 'src/keccak_f.rs', lines 291:0-296:1
    Visibility: public -/
@[reducible]
