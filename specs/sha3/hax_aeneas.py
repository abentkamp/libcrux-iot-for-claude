...
# Aeneas generates `import HacspecSha3.{Types,FunsExternal}`, but the files
# actually live in the `Extraction/` subdirectory. Fix the import paths.
content = content.replace("import HacspecSha3.Types", "import HacspecSha3.Extraction.Types")
content = content.replace("import HacspecSha3.FunsExternal", "import HacspecSha3.Extraction.FunsExternal")
